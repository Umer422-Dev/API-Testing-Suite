...
### Project Overview
This repository contains a comprehensive manual API testing suite and structured bug logging report. Testing was executed on RESTful API endpoints covering **Authentication**, **Authorization**, **Product Management**, and **Office** modules using the Scalar API Documentation/Client interface with Bearer Token authorization.
...
* **Download Full QA Report (.xlsx)** — Complete test execution steps, expected vs actual results, and bug logging sheets.
